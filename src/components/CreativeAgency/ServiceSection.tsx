          ...
          <div className="section-header">
            <div className="section-title-wrapper fade-anim" suppressHydrationWarning={true}>
              <div className="subtitle-wrapper">
                <span className="section-subtitle">{serviceData?.subtitle}</span>
              </div>
            </div>
          </div>
          ...
          <div className="services-wrapper-box fade-anim" suppressHydrationWarning={true}>
            <div className="services-wrapper">
              <div className="area-bg">
                <img src="/assets/imgs/shape/shape-34.webp" alt="background shape" />
              </div>

              <Tab.Container id="services-tabs" activeKey={activeTab} onSelect={handleTabSelect}>
                    ...
                    <Nav.Item key={tab?.id}>
                      <Nav.Link eventKey={tab?.id}>
                        <div className="service-name">
                          <h2 className="title">
                            {tab?.title} <span className="number">{tab?.number}</span>
                          </h2>
                        </div>
                      </Nav.Link>
                    </Nav.Item>
                  ...
                  {serviceData?.navTabs?.map((tab) => (
                    <Tab.Pane eventKey={tab?.id} key={tab?.id}>
                      <div className="service-box-5">
                        <div className="area-bg">
                          <img src="/assets/imgs/shape/shape-33.webp" alt="bg shape" />
                        </div>
                        <div className="thumb">
                ...
                <SwiperSlide key={item?.id}>
                  <div className="text-slider-item-3">
                    <Link href={item?.link}>
                      <h2 className="title">
                        <span className="icon">
                          <img src="/assets/imgs/shape/shape-35.webp" alt="icon" />
                        </span>
