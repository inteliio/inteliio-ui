...
import sidebarData from "@/constant/CreativeAgency/sidebar/sidebarData";
import NestedAccordion from "@/components/CreativeAgency/common/NestedAccordion";
            ...
            <div className="offset-widget-box">
              ...
              <div className="social-links">
                {sidebarData.social.map((social, i) => (
                  <a key={i} href={social.href} target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()}>
                    {social.label}
                  </a>
                ))}
              </div>
