  ...
  return (
    <section className="hero-area-3">
      <div className="container">
        <div className="hero-area-3-inner section-spacing">
          ...
          <div className="section-content-wrapper">
            <div className="content-shape-1 fade-anim btn-item" data-direction="top" data-offset="150" data-ease="bounce" data-delay="1.05" suppressHydrationWarning={true}>
      ...
      <div className="image-wrapper parallax-view fade-anim" suppressHydrationWarning={true}>
        <img className="w-100" src={heroData?.mainImage} alt="hero visual" data-speed="0.5" />
      </div>
    </section>
  );
};
