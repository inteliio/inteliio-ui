        ...
        <div className={`testimonial-area-3-inner ${type === "v2" ? "section-spacing-bottom" : "section-spacing"}`}>
          ...
          <div className="section-header">
            ...
            <div className="slide-nav fade-anim">
              <div className="testimonial-3-button-prev slide-nav-button" role="button">
                <i className="fa-solid fa-arrow-left"></i>
              </div>
              <div className="testimonial-3-button-next slide-nav-button" role="button">
          ...
          <div className="testimonial-wrapper-box fade-anim">
            <div className="testimonial-wrapper">
                    ...
                    <div className="testimonial-item-3">
                      <div className="content">
                        <div className="text-wrapper">
                          <div>
                            <img src="/assets/imgs/shape/shape-51.webp" alt="shape" />
                          </div>
                          <p className="text">
                            {testimonial.text}{" "}
                            <span
                              ...
                              <img src="/assets/imgs/shape/shape-51.webp" alt="shape" style={{ height: "18px" }} />
                            </span>
                          </p>
                        </div>
                        <div className="author">
                          <div className="meta">
                            <h3 className="name has-left-line">{testimonial.name}</h3>
              ...
              <Swiper
                ...
                className="testimonial-3-nav-active"></Swiper>
            </div>
          </div>
        </div>
      </div>
