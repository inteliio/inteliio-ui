...
const infoData: InfoData = {
  shapeImage1: "/assets/imgs/shape/shape-1.webp",
  shapeImage2: "/assets/imgs/shape/shape-53.webp",
  subtitle: "OUR EXPERIENCE",
  title: "In numeric way",
  description: "Always striving to bring cutting-edge ideas to life, from the initial concept phase to the final launch.",
  contactLink: "/contact",
  stats: [
